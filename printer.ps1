...
#get-wmiobject -class win32_printer -computer ps1  | select name, sharedname, printerstate | export-csv  "C:\Users\max1arm\Desktop\printers.csv"
#Get-ADGroup -Filter 'Name -like "imp*"' | select name




### Get GPO deployed printer
<#
.SYNOPSIS     
